...
Primary authorities: practitioner consensus on spike documentation (density, findings-first structure) | GeeksforGeeks — "What Is a Spike in Agile?" | Agilemania — spike documentation guidance

Correction (2026-09): earlier versions of this reference attributed the density and findings-first principles below to "Sophie Déziel — 'How We Do Spikes' (Medium, 2016)." That article and author could not be located or verified in a live search — the citation appears to have been fabricated rather than sourced. The underlying advice is retained because it matches consensus practitioner guidance found elsewhere (Agilemania, GeeksforGeeks, and the general "dense, decision-first" convention seen across SAFe Enabler documentation), but it is no longer attributed to a named, unverifiable source. Treat the principles in this file as this skill's own synthesis unless a citation is given.

---

## 1. The Density Principle

Keep it short, but very dense in information.
...
The most important formatting principle: findings first, reasoning second.
...
**The Evidence and Links sub-section is links, not prose.** Embed findings where the work lives. Link to the actual artefact — a branch, a benchmark report, a Notion page, a video recording. A prose description of what you would find at that link adds length without adding information.
