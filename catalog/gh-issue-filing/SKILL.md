...
# GitHub Issue Filing Skill

This skill turns a rough description into one specific, well-formed GitHub issue. It is not the
skill that designs `.github/ISSUE_TEMPLATE/` forms (that's the sibling `gh-issue-template` skill --
