    ...
    <div className="flex flex-col gap-8">
      <div className="-mx-6 -mt-8 border-b border-slate-200 px-6 py-10 dark:border-slate-800">
        ...
        <p className="mt-2 max-w-2xl text-slate-600 dark:text-slate-400">
          Browse what each skill does, read its full instructions, and download it as a single file
      ...
      {skills.length === 0 ? (
        <div className="rounded-lg border border-slate-200 p-12 text-center dark:border-slate-800">
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            The build found no top-level folder containing a SKILL.md. Add one and redeploy — no
            code changes needed.
          </p>
        </div>
      ) : (
